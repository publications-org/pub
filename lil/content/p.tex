...
\lettrine[lines=1, lhang=0.1, loversize=0.2]{L}ET the following notes on Little Learner's example formulas:

\begin{theorem}
Let the following variables in $\mathbb{R}$ be defined as follows:
\begin{align*}
    \mathcal{L} &= \sum_{k=1}^{\infty} \mathcal{T}_k \otimes \mathcal{Y}_k + C_k.
\end{align*}
Where $C_k$ is a constant term in $\mathbb{R}$.
\end{theorem}
