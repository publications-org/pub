...
\begin{align*}
    \mathcal{X} &= \sum_{k=1}^{\infty} \mathcal{T}_k \otimes \mathcal{Y}_k + C_k.
\end{align*}
...
Next we will observe and study several tactics we can consider for LiL's Input/Output training.
