...
\lettrine[lines=2, lhang=0.1, loversize=0.2]{T}HE document provides a reference for theorems, definitions, and equations for the purpose of being reusable. References are cited at the bottom of each of the paper where credit is due.\\
One caveat: $y(x), \lambda(x), \rho(x)$ are defined generically in this paper.\\However a proof will have the concrete function attributed to them.
