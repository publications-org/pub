...
\lettrine[lines=2, lhang=0.1, loversize=0.2]{T}he paper provides a reference for theorems, definitions, and equations for the purpose of being reusable. References are cited at the bottom of each of the paper where credit is due.\\
