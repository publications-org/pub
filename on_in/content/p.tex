...
\end{remark}
\begin{remark}
	Building upon Remark 1.4, there exists an inequality of:
	\begin{align*}
...
\end{align*}
\end{theorem}
Thus the following proof per previously stated theorems and remarks.
\begin{proof}
...
\end{align*}
This now completes the proof per previous definitions, proof, and theorems.
\end{proof}
Thus the remark:
\begin{remark}
...
\end{corollary}
Moving on to the next section, additional theorems will be stated.
...
\end{remark}
In which there may be applications in computational theory and formal methods.
