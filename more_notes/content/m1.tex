...
\title{%
	\vspace{-1.5em}%
	\large\textbf{Write-up for Future Problems.}%
}
...
\label{rem:math-special-case}
	...
	\end{equation}
	A general use case for a strictly positive natural $n$ and simulation variable $x$ is for $n \neq 0$:
	\begin{equation}
		\mathcal{T}_{0+n} = \iint_{\mathcal{D}} \mathcal{T}(\mathcal{X}_{x+n}, \mathcal{X}_{y+n})_{t+x} \, dx \land dy - \mathcal{R}_{t+n}.
	\end{equation}
	Or, more elegantly for $n \neq 0$:
	\begin{equation}
