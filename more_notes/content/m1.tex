...
\begin{align*}
    \mathcal{C} &= \mathcal{N}(x) - y \cdot \int_{n}^{p} \mathcal{T}_{n} \cdot t \quad dt,\\
    \mathcal{C} - \mathcal{N}(x) &= -y \cdot \int_{n}^{p} \mathcal{T}_{n} \cdot t \quad dt,\\
    \mathcal{C} \pm \frac{\mathcal{N}(x)}{y} &= \int_{n}^{p} \mathcal{T}_{n} \cdot t \quad dt, \quad t \in \mathbb{R}.
\end{align*}
