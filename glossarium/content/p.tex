...
\lettrine[lines=2, lhang=0.1, loversize=0.2]{L}et ourselves define the following in rigorous mathematics in a manner that let us reuse them later by subtracting the functions with our own.\\
...
\lettrine[lines=2, lhang=0.1, loversize=0.2]{W}e will now proceed to plot and analyze the following theorems to analyze their convergence and general behavior.

\section{Plotting and Analysis of previous theorems:}
...
The following plot were written using 'python3' using the 'matplotlib' library.
...
Which in the next chapter 'On Theorems' will be used to plot some of our theorems.
