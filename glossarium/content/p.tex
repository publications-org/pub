...
\begin{theorem}
	...
	\begin{align*}
		...
		\Delta y &= \ln x,
	\end{align*}
	Separately, we find $\forall I, r, x, \Delta x, n \in \mathbb{R}$ that equals:
	\begin{align*}
...
\lettrine[lines=2, lhang=0.1, loversize=0.2]{T}he nine pages of theorems now comes to an end, stating them here was the first step to then develop a framework later in the 'AWB' book. We will next plot and analyse our results based of our theorems and definitions.
