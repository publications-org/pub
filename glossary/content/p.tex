...
\begin{theorem}
	Let a theorem of the following equations for any $\forall x, n \in \mathbb{R}$:
	\begin{align*}
...
\begin{theorem}
	Let an equation of the following for $\forall x, y, z \in \mathbb{R}$:
	\begin{align*}
...
\begin{theorem}
	Let for $\forall a, q, k, x \in \mathbb{R}$:
	\begin{align*}
...
\begin{theorem}
	...
	\end{align*}
	Let us impose two inequalities in $\mathbb{R}.$:
	\begin{align*}
...
\lettrine[lines=2, lhang=0.1, loversize=0.2]{T}he nine pages of theorems now comes to an end, stating them here was the first step to then develop a framework later in the AWB.

\nocite{*}

\bibliographystyle{acm}
\bibliography{Bell_System_Hartley, S0022314X10001836, Fatou1906, A_Course_of_Pure_Mathematics, General_Theory_Dirichlet_Series, Riemann, bonito2026}
