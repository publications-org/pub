...
\begin{document}
	...
	\lettrine[lines=1, lhang=0.1, loversize=0.2]{W}hile a short paper, the purpose is for the development of methodology on using proof assistants for non-trivial conjectures and theorems of Pure Mathematics.
	
\nocite{*}
	
\bibliographystyle{acm}
\bibliography{A_Course_of_Pure_Mathematics, wiles, avigad}
