...
\title{%
	\vspace{-1.5em}%
	\large\textbf{Using the Lean Proof Assistant for Non-Trivial Theorems.}%
}
...
\begin{document}
	...
	%% ============================================================
	\section{Using Lean for Non-Trivial Theorems:}
	%% ============================================================
	...
	%% ============================================================
	\subsection{Applying Proofs to Non-Trivial Theorems:}
	%% ============================================================

	\lettrine[lines=1, lhang=0.1, loversize=0.2]{L}et the following theorem for $x, y, z \in \mathbb{Z}$. The following theorem per FLT (Fermat' Last Theorem) admits an identity for the following:
	...
	One way to prove Theorem [1.1] is using proofs by direct and induction of FLT.
	\subsection{On the Lean Rationale and Final Words:}
	...
	\lettrine[lines=1, lhang=0.1, loversize=0.2]{W}hile an abrupt document, its purpose is for the development of methodology on using proof assistants for non-trivial conjectures and theorems in non-trivial subdomains of Mathematics or Computer Science.
	
\nocite{*}
	
\bibliographystyle{acm}
\bibliography{wiles, avigad}
