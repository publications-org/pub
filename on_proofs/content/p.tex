...
\begin{document}
	...
	\lettrine[lines=1, lhang=0.1, loversize=0.2]{L}et the following theorem for $x, y, z \in \mathbb{Z}$. The following theorem per FLT admits an identity for the following:
