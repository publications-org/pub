...
\title{%
	\vspace{-1.5em}%
	\large\textbf{Glossary of Theorems and Definitions.}%
}
...
\begin{theorem}
	Let for any variables $\forall a, \mu, \lambda, b, c \in \mathbb{R}$.:
	\begin{align*}
...
\begin{theorem}
	...
	\begin{align*}
		\mathcal{L} + \lambda(x)^{2} &= \frac{\gamma(x)}{\delta(x)},\\
	 	...
	 	\mathcal{L} &= \frac{\gamma(x)}{\delta(x)  \lambda(x) } - \lambda(x), \quad \delta(x)\lambda(x) \neq 0.
	\end{align*}
