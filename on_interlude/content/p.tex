...
\begin{align*}
	\epsilon &\coloneq \frac{\zeta(3)}{\pi},\\
...
\end{proof}
\begin{theorem}
There exists the following equation in $\mathbb{R}.$ And $\forall a, q, k \in \mathbb{R}$:
\begin{align*}
...
\begin{align*}
	\sum_{k=1}^{\pi} \frac{\gamma(a, qk)}{k} + (\pi^{1/12} - \frac{1}{\pi}) &= \pm \frac{\pi}{\zeta(3)},\\
	\sum_{k=1}^{\pi} \frac{\gamma(a, qk)}{k} &= \pm \frac{\pi}{\zeta(3)} - (\pi^{1/12} - \frac{1}{\pi}) .
\end{align*}
\end{theorem}
\begin{proof}
