...
\begin{definition}
	There exists for $\sqrt{\Delta x}$ and a variable $\lambda.$:
	\begin{align*}
		\lambda y \sqrt{\Delta x} &= \frac{\operatorname{d}}{\operatorname{d}\Delta x} + z;\\
		\lambda y \sqrt{\Delta x} - \frac{\operatorname{d}}{\operatorname{d}\Delta x} &= \pm z; \quad z \neq 0.
	\end{align*}
\end{definition}
