...
\begin{document}
	...
	\begin{theorem}
		...
		\begin{align*}
			x^{n} + y^{n} + z^{n} &= p^{n}, \, \forall n, c, x, y, z, p \neq 0, n \geq 2.
		\end{align*}
		...
		\begin{align*}
			x^{n} + y^{n} + z^{n} \neq 0, \, x^{n} + y^{n} + z^{n} &\geq 2, \, \forall x^{n} + y^{n} + z^{n} \in \mathbb{Z}.
		\end{align*}
		Thus we can induce the following for $\forall x^{n} + y^{n} + z^{n} \in \mathbb{Z}.$:
		\begin{align*}
			x^{n} + y^{n} + z^{n} -  a^{n} &= b^{n}, \, x^{n} + y^{n} + z^{n} - b^{n} = a^{n}.
		\end{align*}
		If and only If for $\forall x^{n} + y^{n} + z^{n} \in \mathbb{Z}.$:
		\begin{align*}
			x^{n} + y^{n} + z^{n} -  a^{n} - b^{n} &= 0, \, x^{n} + y^{n} + z^{n} \neq 0.
		\end{align*}
	\end{theorem}
	\begin{remark}
